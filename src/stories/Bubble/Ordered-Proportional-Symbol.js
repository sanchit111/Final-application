...
const name = text("Title", "Ordered Proportional Symbol");
...
const value8 = number("Marker Size 1",  20);
const value9 = number("Marker Size 2",  40);
const value10 = number("Marker Size 3", 60);
const value11 = number("Marker Size 4", 80);
